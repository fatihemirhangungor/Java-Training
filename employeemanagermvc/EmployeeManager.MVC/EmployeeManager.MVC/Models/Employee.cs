...
namespace EmployeeManager.MVC.Models
{
    ...
    public class Employee
    {
        ...
        [StringLength(10,ErrorMessage ="First Name must be less than 10 Chars")]
        public string FirstName { get; set; }

        [Column("LastName")]
        [Required(ErrorMessage = "LastName is required")]
        [Display(Name = "Last Name")]
        [StringLength(20, ErrorMessage = "Last Name must be less than 20 Chars")]
        public string LastName { get; set; }

        [Column("Title")]
        [Required(ErrorMessage = "Title is required")]
        [Display(Name = "Title")]
        [StringLength(30, ErrorMessage = "Title must be less than 30 Chars")]
